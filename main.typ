...
若通过编程，令机器把某种人类能看懂的「任务描述」转化成「执行结果」，就可以认为实现了一个编程语言。暂时不知道编程语言具体长啥样没关系，本 Talk 后面会有不少例子。

一个有趣的思考题：既然要用编程来创造新的编程语言，第一个编程语言是怎么来的呢？
] 
...
刚刚我们也看到了代码大概长啥样。要处理这种代码，我们首先需要不少小零件，例如：
